// ============================================================
// LABIATAE — SINGLE FILE VERSION for Swift Playgrounds iPad
//
// HOW TO USE:
...
func findStep(_ id: String) -> KeyStep? { keySteps.first { $0.id == id } }
func findPlant(_ id: Int) -> Plant? { allPlants.first { $0.id == id } }
...
struct IdentifyView: View {
    ...
    func choose(_ result: KeyResult) {
        ...
        questionCount += 1
        switch result {
        case .step(let id): currentStep = findStep(id); foundPlant = nil
        case .plant(let id): foundPlant = findPlant(id); currentStep = nil
        }
    }
